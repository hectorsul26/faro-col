...
Todo reporte confirmado se publica en el canal público [{{CHANNEL_USERNAME}}]({{CHANNEL_URL}}). El contenido podrá ser visto, copiado o reenviado por otras personas. Faro Col no puede garantizar la eliminación de copias o reenvíos después de la publicación.
